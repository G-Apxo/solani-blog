      	...
      	# code...
			...
			<a href="single.php?id='.$griditem['id'].'">
			   <div class="card">
				  ...
				  <img src="blogadmin/images/'.$griditem['photo'].'" class="img-fluid" alt="fantastic cms" style="width:100%;height: 30vh;"> 
				  </div>
				  <div class="card-content">
					 <div class="h1 mac__prjects_content">'.$griditem['title'].'</div>
					 <br/>
					 <br/>
					 <p class="medium project__content " >'.$griditem['tags'].'</p>
				  </div>
			   </div>
			</a>
		 </li>
